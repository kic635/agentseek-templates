...
`.env` is the readiness and lifecycle env source for `agentseek doctor`. During
`agentseek dev`, it is passed to development child processes; exported shell
values take precedence. The Bub gateway and AG-UI
